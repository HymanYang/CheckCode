...
>
>[修复后的Xpose-app](https://static.yunjiglobal.com/qnUpload/app/XposedInstaller_3.1.5-debug[修复http请求].apk)
...
| getIpAddress           | android.net.wifi.WifiInfo            | 获取IP地址                            |
...
| getInstalledPackages   | android.app.ApplicationPackageManager| 获取手机应用列表  |
...
hook权限核心代码：【后续，可以根据自己需要检查的代码，做相应的hook行为】
